                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Painel de Valores</h3>
                                        <div class="nk-block-des text-soft">
                                            <p>Seja Bem Vindo(a) {{auth()->user()->name}}</p>
                                            <p>Valores incorretos - devido manutenção</p>
                                            ...
                                            <div class="card-inner">
                                                <div class="card-title-group align-start mb-0">
                                                    <div class="card-title">
                                                        <h6 class="subtitle">Valor Total da Agua</h6>
                                                    </div>
                                                ...
                                                <div class="card-amount">
                                                    <span class="amount">R$ 2,759 <span class="currency currency-usd">BRL</span>
                                                    </span>
