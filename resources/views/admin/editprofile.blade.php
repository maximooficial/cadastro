...
@endif
                ...
                <form action="{{route('adminupdate', $edit->id) }}" method="post"> 
...
<div class="row mt-2">
<div class="col-md-6"><label class="labels">CPF</label><input type="text" name="cpf" class="form-control" placeholder="cpf" value="{{ $edit->cpf }}" ></div>
...
<div class="row mt-3">
<div>
<input type="radio" id="{{ $edit->status }}" name="status" value="Tudo Ok"
 >
  <label for="huey">Cadastro Ok</label>
  </div>

<div>
  <input type="radio" id="{{ $edit->status }}" name="status" value="Sem Terreno"   >
  <label for="dewey">Sem Terreno</label>
</div>

<div>
  <input type="radio" id="{{ $edit->status }}" name="status" value="Terreno Vazio"  >
  <label for="louie">Terreno Vazio</label>
</div>
<div>
  <input type="radio" id="{{ $edit->status }}" name="status" value="Saiu do Terreno" >
  <label for="louie">Saiu do Terreno</label>
</div></div></div>
...
['cpf', 'name', 'email', 'password','birthday',  'telefone', 'conjuge',
    ...
    'quadra','valor1','valor2','valor3','valor4','valor5','total','status'];  -->
        ...
        <div class="p-3 py-5">
                ...
                <div class="mt-5 text-center"><a href="/admin/editvalores/{{ $edit->id }}" class="btn btn-primary profile-button" type="submit"> Adicionar Valores</a>
